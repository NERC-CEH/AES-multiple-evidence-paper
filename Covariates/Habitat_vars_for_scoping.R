...
lcm17 <- read.csv(paste0(fpath,"lcm17_1km.csv"))

lcm18 <- read.csv(paste0(fpath,"lcm18_1km.csv"))

lcm19 <- read.csv(paste0(fpath,"lcm19_1km.csv"))
...
arableall <- rbind(arable17, arable18, arable19)
...
grassall <- rbind(grass17, grass18, grass19)
...
snhaall <- rbind(snha17, snha18, snha19)
...
snhball <- rbind(snhb17, snhb18, snhb19)
#' 
...
snhcall <- rbind(snhc17, snhc18, snhc19)
#' 
#' 
#' ### 4 - Habitat diversity
#' 
...
habdivall <- rbind(c17[,c(1,11,12)], c18[,c(1,11,12)], c19[,c(1,11,12)])
...
#' 
#' Anyway....for now will ignore and write out hab file
#' 
#' #' Replace NAs with zeroes (look at me using apply!)
#' 
