...
p1 <- ggpredict(Rich_LS_mod, "AES1KM[-0.60:2.42, by = 0.5]",
                condition = c("AES3KM" = "0.362",
                              "ROUND_NUMBER" = "0.4",
                              "SURVEY_YEAR" = "2018",
                              "Climate_PC1" = "-0.04",
                              "Landscape_PC1" = "-0.05",
...
p2 <- ggpredict(Rich_WCBS_mod, "AES1KM[-0.60:6.66, by = 0.5]",
                condition = c("AES3KM" = "0.362",
                              "N_VISITS_MAYTOAUGUST" = "0.4",
                              "SURVEY_YEAR" = "2018",
                              "Climate_PC1" = "-0.04",
...
p3 <- ggpredict(Rich_UKBMS_mod, "AES1KM[-0.60:7.38, by = 0.5]",
                condition = c("AES3KM" = "0.362",
                              "N_VISITS_MAYTOAUGUST" = "0.4",
                              "SURVEY_YEAR" = "2018",
                              "Climate_PC1" = "-0.04",
