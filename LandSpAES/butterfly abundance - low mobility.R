...
mod1 <- glmer.nb(BUTTERFLY_COUNT ~ AES1KM*AES3KM + ROUND_NUMBER + PERC_SUN + SURVEY_TEMP_SHADE + SURVEY_YEAR + 
                   (1|SURVEY_SQUARE), data = buttabund)
...
mod2 <- glmer.nb(BUTTERFLY_COUNT ~ AES1KM*AES3KM + ROUND_NUMBER  + PERC_SUN + SURVEY_TEMP_SHADE + SURVEY_YEAR +  
                   (1|SURVEY_SQUARE), data = buttabund2)
...
## predict
pred.data1 <- pred_conf(mod = mod1, pred_data = pred.data1, col_id = 'BUTTERFLY_COUNT', re_name = 'SURVEY_SQUARE')
pred.data2 <- pred_conf(mod = mod1, pred_data = pred.data2, col_id = 'BUTTERFLY_COUNT', re_name = 'SURVEY_SQUARE')
...
mod2_lowland <- glmer.nb(BUTTERFLY_COUNT ~ AES1KM*AES3KM + ROUND_NUMBER  + PERC_SUN + SURVEY_TEMP_SHADE + SURVEY_YEAR +  
                           (1|SURVEY_SQUARE), data = buttabund2_lowland)
...
## predict
pred.data1_lowland <- pred_conf(mod = mod1_lowland, pred_data = pred.data1_lowland, col_id = 'BUTTERFLY_COUNT', re_name = 'SURVEY_SQUARE')
pred.data2_lowland <- pred_conf(mod = mod1_lowland, pred_data = pred.data2_lowland, col_id = 'BUTTERFLY_COUNT', re_name = 'SURVEY_SQUARE')
